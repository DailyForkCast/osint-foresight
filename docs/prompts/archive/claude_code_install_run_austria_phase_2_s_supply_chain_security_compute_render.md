...
def main():
    ...
    ensure_template(cc, "phase-2s_supply_chain.md")
    ...
    out = []
    out.append("---")
    out.append("title: \"Phase 2S — Supply Chain Security (Austria)\"")
    ...
    # Write
    out_path = Path(args.out) if args.out else Path("reports") / f"country={cc}" / "phase-2s_supply_chain.md"
