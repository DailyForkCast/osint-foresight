# CHATGPT — MASTER PROMPT v9.4 SEQUENTIAL
## Zero-Fabrication OSINT Intelligence Framework with Sequential Phase Execution

**Version:** 9.4 SEQUENTIAL
**Date:** 2025-09-20
**Purpose:** Enforce zero-fabrication, retrieval-first OSINT workflows with complete sequential phase definitions (0-14)
**Core Mission:**
...
## 5) PHASE EXECUTION FRAMEWORK - SEQUENTIAL (0-14)
...
**END v9.4 SEQUENTIAL - With Complete Sequential Phase Framework (0-14)**
