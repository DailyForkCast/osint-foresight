# src/analysis/phase5_institutions.py
...
def main():
    ...
    ensure_template(CC, "phase-5_institutions.md")
    ...
    out: List[str] = []
    out.append("---")
    out.append("title: \"Phase 5 — Institutions & Accredited Labs (Austria)\"")
    ...
    # Write
    out_path = Path(args.out) if args.out else Path("reports") / f"country={CC}" / "phase-5_institutions.md"
