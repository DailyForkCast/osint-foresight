# src/analysis/phase3_landscape.py
...
def main(argv: List[str] | None = None) -> int:
    ...
    ensure_template(ccode, "phase-3_landscape.md")
    ...
    out_path = Path(args.out) if args.out else Path("reports") / f"country={ccode}" / "phase-3_landscape.md"
    out_path.parent.mkdir(parents=True, exist_ok=True)

    # Build markdown
    md = []
    md.append("---")
    md.append("title: \"Phase 3 — Technology Landscape & Maturity (Austria)\"")
