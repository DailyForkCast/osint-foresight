#!/usr/bin/env python3
"""Add Spanish Government (Presidency)"""
import sqlite3
import json
...
def add_executive():
    ...
    institution = {
        ...
        'name_native': 'Gobierno de España',
        'type': 'executive',
        'website': 'https://www.lamoncloa.gob.es'
    }

    inst_id = generate_id("es_national", institution['name'])
    notes = json.dumps({
    ...
    ''', (inst_id, institution['name'], institution['name_native'], institution['type'],
          'national', 'ES', institution['website'], None, 'active', notes,
