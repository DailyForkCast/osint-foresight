#!/usr/bin/env python3
"""
China Policy Collector - Production Runner (FIXED)
...
class ProductionRunner:
    ...
    def __init__(self, bucket_name: str = 'SECONDARY'):
        ...
        # Load source configuration (use COMPLETE which includes diplomatic missions)
    ...
    def get_bucket_sources(self) -> List[Dict]:
        ...
        # FIXED: In the YAML, bucket names are top-level keys with source lists
