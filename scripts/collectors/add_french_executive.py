#!/usr/bin/env python3
"""Add French Presidency and Prime Minister's Office"""
import sqlite3
import json
...
def add_executive():
    ...
    institutions = [
        {
            ...
            'name_native': 'Présidence de la République française',
            'type': 'executive',
            'website': 'https://www.elysee.fr'
        },
        {
            'name': 'Prime Minister of France',
            'name_native': 'Premier ministre',
            'type': 'executive',
    ...
    for institution in institutions:
        inst_id = generate_id("fr_national", institution['name'])
        notes = json.dumps({
        ...
        ''', (inst_id, institution['name'], institution['name_native'], institution['type'],
              'national', 'FR', institution['website'], None, 'active', notes,
