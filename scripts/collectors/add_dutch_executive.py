#!/usr/bin/env python3
"""Add Dutch Government (Prime Minister's Office)"""
import sqlite3
import json
...
def add_executive():
    ...
    institution = {
        ...
        'name_native': 'Rijksoverheid',
        'type': 'executive',
        'website': 'https://www.government.nl'
    }

    inst_id = generate_id("nl_national", institution['name'])
    notes = json.dumps({
    ...
    ''', (inst_id, institution['name'], institution['name_native'], institution['type'],
          'national', 'NL', institution['website'], None, 'active', notes,
