"""
Query arXiv API for Quantum Technology publications (2020-2025)
...
# Quantum-relevant arXiv categories
QUANTUM_CATEGORIES = {
    'quant-ph': 'Quantum Physics',
    'cond-mat.mes-hall': 'Mesoscale and Nanoscale Physics (Quantum Materials)',
...
def analyze_quantum_publications():
    """Query arXiv for Quantum publications (2020-2025)"""
    print("=" * 80)
    print("arXiv QUANTUM TECHNOLOGY PUBLICATION ANALYSIS")
    print("=" * 80)
    print()
    ...
    results = {
        'metadata': {
            ...
            'categories': list(QUANTUM_CATEGORIES.keys()),
    ...
    for category in sorted(QUANTUM_CATEGORIES.keys()):
        print(f"\n{'=' * 80}")
        print(f"Category: {category} - {QUANTUM_CATEGORIES[category]}")
        print(f"{'=' * 80}")
    ...
    for category in sorted(QUANTUM_CATEGORIES.keys()):
        print(f"\n{category} - {QUANTUM_CATEGORIES[category]}:")
    ...
    # Totals
    print(f"\n{'=' * 80}")
    print("TOTAL QUANTUM PAPERS PER YEAR:")
    print(f"{'=' * 80}")
    ...
    # Save
    output_file = Path("C:/Projects/OSINT - Foresight/analysis/quantum_tech/arxiv_quantum_analysis.json")
...
if __name__ == '__main__':
    print("Starting arXiv Quantum analysis...")
    print("Estimated time: 15-20 minutes (rate limiting: 3 sec between requests)")
    print()

    results = analyze_quantum_publications()
