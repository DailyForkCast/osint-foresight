"""
Build Tracker v18 - Pure Values Only (NO FORMULAS AT ALL)
Load v12 with data_only=True to get VALUES not FORMULAS
"""
...
print("="*80)
print("BUILDING TRACKER V18 - PURE VALUES ONLY")
print("="*80)

# Load v12 with data_only=TRUE to get VALUES not FORMULAS
print("\nLoading v12 with data_only=True (values only)...")
...
SUBREGIONS = {
    ...
    'TN': 'Northern Africa', 'SD': 'Northern Africa', 'BJ': 'Western Africa', 'BF': 'Western Africa',
    'CV': 'Western Africa', 'CI': 'Western Africa', 'GM': 'Western Africa', 'GH': 'Western Africa',
    'GN': 'Western Africa', 'GW': 'Western Africa', 'LR': 'Western Africa', 'ML': 'Western Africa',
    'MR': 'Western Africa', 'NE': 'Western Africa', 'NG': 'Western Africa', 'SN': 'Western Africa',
    'SL': 'Western Africa', 'TG': 'Western Africa', 'BI': 'Eastern Africa', 'KM': 'Eastern Africa',
    'DJ': 'Eastern Africa', 'ER': 'Eastern Africa', 'ET': 'Eastern Africa', 'KE': 'Eastern Africa',
    'MG': 'Eastern Africa', 'MW': 'Eastern Africa', 'MU': 'Eastern Africa', 'MZ': 'Eastern Africa',
    ...
    'SZ': 'Southern Africa', 'DK': 'Northern Europe', 'EE': 'Northern Europe', 'FI': 'Northern Europe',
    'IS': 'Northern Europe', 'IE': 'Northern Europe', 'LV': 'Northern Europe', 'LT': 'Northern Europe',
    'NO': 'Northern Europe', 'SE': 'Northern Europe', 'GB': 'Northern Europe', 'BY': 'Eastern Europe',
    'BG': 'Eastern Europe', 'CZ': 'Eastern Europe', 'HU': 'Eastern Europe', 'MD': 'Eastern Europe',
    'PL': 'Eastern Europe', 'RO': 'Eastern Europe', 'RU': 'Eastern Europe', 'SK': 'Eastern Europe',
    'UA': 'Eastern Europe', 'AL': 'Southern Europe', 'AD': 'Southern Europe', 'BA': 'Southern Europe',
    'HR': 'Southern Europe', 'CY': 'Southern Europe', 'GR': 'Southern Europe', 'IT': 'Southern Europe',
    'XK': 'Southern Europe', 'MK': 'Southern Europe', 'MT': 'Southern Europe', 'ME': 'Southern Europe',
    'PT': 'Southern Europe', 'RS': 'Southern Europe', 'SI': 'Southern Europe', 'ES': 'Southern Europe',
    'VA': 'Southern Europe', 'AT': 'Western Europe', 'BE': 'Western Europe', 'FR': 'Western Europe',
    'DE': 'Western Europe', 'LI': 'Western Europe', 'LU': 'Western Europe', 'MC': 'Western Europe',
    'NL': 'Western Europe', 'CH': 'Western Europe', 'AM': 'Caucasus', 'AZ': 'Caucasus', 'GE': 'Caucasus',
    'TR': 'Western Asia', 'CA': 'Northern America', 'US': 'Northern America', 'BZ': 'Central America',
    'CR': 'Central America', 'SV': 'Central America', 'GT': 'Central America', 'HN': 'Central America',
    'MX': 'Central America', 'NI': 'Central America', 'PA': 'Central America', 'AG': 'Caribbean',
    'BS': 'Caribbean', 'BB': 'Caribbean', 'CU': 'Caribbean', 'DM': 'Caribbean', 'DO': 'Caribbean',
    'GD': 'Caribbean', 'HT': 'Caribbean', 'JM': 'Caribbean', 'KN': 'Caribbean', 'LC': 'Caribbean',
    'VC': 'Caribbean', 'TT': 'Caribbean', 'AR': 'South America', 'BO': 'South America', 'BR': 'South America',
    'CL': 'South America', 'CO': 'South America', 'EC': 'South America', 'GY': 'South America',
    'PY': 'South America', 'PE': 'South America', 'SR': 'South America', 'UY': 'South America',
    'VE': 'South America', 'CN': 'Eastern Asia', 'JP': 'Eastern Asia', 'KP': 'Eastern Asia',
    'KR': 'Eastern Asia', 'MN': 'Eastern Asia', 'TW': 'Eastern Asia', 'BN': 'South-Eastern Asia',
    'KH': 'South-Eastern Asia', 'ID': 'South-Eastern Asia', 'LA': 'South-Eastern Asia', 'MY': 'South-Eastern Asia',
    'MM': 'South-Eastern Asia', 'PH': 'South-Eastern Asia', 'SG': 'South-Eastern Asia', 'TH': 'South-Eastern Asia',
    'TL': 'South-Eastern Asia', 'VN': 'South-Eastern Asia', 'AF': 'Southern Asia', 'BD': 'Southern Asia',
    'BT': 'Southern Asia', 'IN': 'Southern Asia', 'MV': 'Southern Asia', 'NP': 'Southern Asia',
    'PK': 'Southern Asia', 'LK': 'Southern Asia', 'KZ': 'Central Asia', 'KG': 'Central Asia',
    'TJ': 'Central Asia', 'TM': 'Central Asia', 'UZ': 'Central Asia', 'AU': 'Australia and New Zealand',
    'NZ': 'Australia and New Zealand', 'FJ': 'Melanesia', 'PG': 'Melanesia', 'SB': 'Melanesia',
    'VU': 'Melanesia', 'KI': 'Micronesia', 'MH': 'Micronesia', 'FM': 'Micronesia', 'NR': 'Micronesia',
    'PW': 'Micronesia', 'WS': 'Polynesia', 'TO': 'Polynesia', 'TV': 'Polynesia', 'BH': 'Arabian Peninsula',
    'KW': 'Arabian Peninsula', 'OM': 'Arabian Peninsula', 'QA': 'Arabian Peninsula', 'SA': 'Arabian Peninsula',
    'AE': 'Arabian Peninsula', 'YE': 'Arabian Peninsula', 'IL': 'Levant', 'JO': 'Levant', 'LB': 'Levant',
    'PS': 'Levant', 'SY': 'Levant', 'IQ': 'Mesopotamia',
}

# 1. Master_Projects
print("1. Master_Projects (values only)...")
...
for old_row in range(2, ws_old.max_row + 1):
    new_row = old_row
    # Only copy columns that DON'T have formulas in v12
    # A-C: Basic project info
    for col in [1, 2, 3, 4, 5, 6, 7, 8, 11, 12, 13]:  # Skip J (Days_Remaining - has formula)
        val = ws_old.cell(old_row, col).value
        if val is not None:  # Only copy if there's a value
            ws.cell(new_row, col).value = val

# 2. Country_Budgets
print("2. Country_Budgets (values only)...")
...
for old_row in range(2, ws_old.max_row + 1):
    new_row = old_row
    # B-D: IDs and country code (skip A which has formula)
    for col in [2, 3, 4]:
        val = ws_old.cell(old_row, col).value
        if val is not None:
            ws.cell(new_row, col).value = val

    # F: Proposed (new, set to 0)
    ws.cell(new_row, 6).value = 0

    # G-I: Allocated, Obligated, Spent (columns 6-8 in old)
...
# 6. Formula Guide - Store formulas as TEXT not formulas
print("6. Creating FORMULA_GUIDE (text only)...")
...
ws['B7'] = "'=SUMIF(Country_Budgets!$B:$B,A2,Country_Budgets!$F:$F)"
ws['A8'] = "Column O (Total_Allocation) - Start at O2:"
ws['B9'] = "'=SUMIF(Country_Budgets!$B:$B,A2,Country_Budgets!$G:$G)"
ws['A10'] = "Column P (Total_Obligated) - Start at P2:"
ws['B11'] = "'=SUMIF(Country_Budgets!$B:$B,A2,Country_Budgets!$H:$H)"
ws['A12'] = "Column Q (Total_ULO) - Start at Q2:"
ws['B13'] = "'=SUMIF(Country_Budgets!$B:$B,A2,Country_Budgets!$J:$J)"
ws['A14'] = "Column R (ULO_Percent) - Start at R2:"
ws['B15'] = "'=IF(P2>0,Q2/P2,0)"

ws['A17'] = "COUNTRY_BUDGETS FORMULAS:"
ws['A17'].font = Font(bold=True, size=12)
ws['A18'] = "Column J (ULO) - Start at J2:"
ws['B19'] = "'=H2-I2"
ws['A20'] = "Column K (ULO_Percent) - Start at K2:"
ws['B21'] = "'=IF(H2>0,J2/H2,0)"
...
print("\n" + "="*80)
print("V18 BUILD COMPLETE!")
print("="*80)
print("\nFile: 2025-10-26-Tracker-v18.xlsx")
print("\nThis file has:")
print("  - Pure VALUES only (loaded with data_only=True)")
print("  - NO formulas anywhere")
print("  - FORMULA_GUIDE with formulas in column B")
