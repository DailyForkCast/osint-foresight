...
# SLIDE 9 V7 - FIXED BOX HEIGHTS AND TEXT COLORS
...
for i, init in enumerate(initiatives):
    ...
    # Description text
    # Position: 0.56" from start (0.15" + 0.01" + 0.35" + 0.05")
...
# FIXED: dark_slate text on white background (was white on white!)
...
# Save
output_path = 'C:/Projects/OSINT-Foresight/MCF_Slide9_Redesign_v7_FINAL.pptx'
prs.save(output_path)

print("=" * 80)
print("SLIDE 9 V7 - FIXED BOX HEIGHTS AND TEXT COLORS")
print("=" * 80)
print()
print("FIXES from V6:")
print("  [X] Name box height: 0.12\" -> 0.35\" (PROPER SIZE)")
print("  [X] Name box now has room for text:")
print("      - Box: 0.35\"")
print("      - Padding: 0.18\"")
print("      - Available: 0.17\" (fits 1 line at 0.1625\")")
print("  [X] Bottom box text: white -> dark_slate (NOW VISIBLE)")
print("  [X] All text now properly visible")
print()
print("Box Height Calculations:")
print("  Name boxes (1 line of 9pt):")
...
print()
print("Text Color Fixes:")
print("  Bottom boxes: dark_slate text on white background")
print("  (was: white text on white background = invisible!)")
print()
