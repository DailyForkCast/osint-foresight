...
# SLIDE 9 V7.1 - COMPACT WITH TIGHT SPACING FOR LONG NAMES
...
# FIVE INITIATIVES - V7 COMPACT LAYOUT WITH SPECIAL FORMATTING
initiatives_y = 1.67
...
for i, init in enumerate(initiatives):
    ...
    # Position: after acronym (0.15") + gap (0.01") + name (0.35") + gap (0.05") = 0.56"
...
for i, init in enumerate(initiatives):
    ...
    # Full name - with tight_spacing flag for long names
    create_text_box(slide, x_pos, initiatives_y + 0.16, initiative_width, name_height,
                    ...
                    vertical_anchor=MSO_VERTICAL_ANCHOR.TOP,
                    tight_spacing=init['tight_spacing'])  # Special formatting for GDI and GAGI
...
# Bottom sections - V7 position (more compact)
...
# Save
output_path = 'C:/Projects/OSINT-Foresight/MCF_Slide9_Redesign_v7_1_FINAL.pptx'
prs.save(output_path)

print("=" * 80)
print("SLIDE 9 V7.1 - COMPACT WITH TIGHT SPACING FOR LONG NAMES")
print("=" * 80)
print()
print("APPROACH:")
print("  - Keeps V7's compact layout (name boxes = 0.35\")")
print("  - Applies tight spacing ONLY to the 2 long names:")
print("    * Global Development Initiative")
print("    * Global AI Governance Initiative")
print()
print("TIGHT SPACING ADJUSTMENTS:")
print("  Standard names (DSR, GSI, GCI):")
print("    - space_before: 6pt")
print("    - space_after: 6pt")
print("    - line_spacing: 1.3")
print()
print("  Long names (GDI, GAGI):")
print("    - space_before: 0pt (removed)")
print("    - space_after: 0pt (removed)")
print("    - line_spacing: 1.15 (tighter)")
print()
print("Layout (same as V7):")
print("  Acronym: 1.67\" - 1.82\" (0.15\")")
print("  Name: 1.83\" - 2.18\" (0.35\")")
print("  Description: 2.23\" - 2.73\" (0.50\")")
print("  Bottom section: 3.03\"")
print()
print("Benefits:")
print("  [X] More compact overall layout")
print("  [X] Consistent box sizes across all initiatives")
print("  [X] Long names fit with tighter formatting")
print("  [X] Short names have normal, comfortable spacing")
print()
