...
# SLIDE 9 V7.2 - FIXED BRI SECTION ALIGNMENT
...
# Section header - explicit TOP alignment
create_text_box(slide, 0.3, 0.7, 4.5, 0.25,
                "Strategic Architecture",
                14, COLORS['red'], bold=True, alignment=PP_PARAGRAPH_ALIGNMENT.LEFT,
                vertical_anchor=MSO_VERTICAL_ANCHOR.TOP)

# BRI section - FIXED STRUCTURE
bri_y = 1.05
bri_width = 9.4

# Orange background for entire BRI section
create_colored_box(slide, 0.3, bri_y, bri_width, 0.45, COLORS['orange'])

# BRI Title - in colored bar with MIDDLE alignment
create_text_box(slide, 0.3, bri_y, bri_width, 0.20,
                "Belt and Road Initiative (BRI)",
                11, COLORS['white'], bold=True, alignment=PP_PARAGRAPH_ALIGNMENT.LEFT,
                vertical_anchor=MSO_VERTICAL_ANCHOR.MIDDLE)

# BRI Description - below title with TOP alignment
...
# Save
output_path = 'C:/Projects/OSINT-Foresight/MCF_Slide9_Redesign_v7_2_FINAL.pptx'
prs.save(output_path)

print("=" * 80)
print("SLIDE 9 V7.2 - FIXED BRI SECTION ALIGNMENT")
print("=" * 80)
print()
print("FIXES from V7.1:")
print("  [X] 'Strategic Architecture' - explicit TOP alignment")
print("  [X] 'Belt and Road Initiative (BRI)' - MIDDLE vertical alignment")
print("  [X] BRI description - proper TOP alignment with correct height")
print()
print("BRI Section Structure:")
print("  Orange background: 1.05\" - 1.50\" (0.45\" tall)")
print("    |")
print("    +-- Title box: 1.05\" - 1.25\" (0.20\" tall, MIDDLE aligned)")
print("    |   'Belt and Road Initiative (BRI)'")
print("    |")
print("    +-- Description box: 1.27\" - 1.50\" (0.23\" tall, TOP aligned)")
print("        'Physical + digital infrastructure...'")
print()
print("Alignment Settings:")
print("  - Main title: MIDDLE (centered in red bar)")
print("  - Strategic Architecture: TOP (header text)")
print("  - BRI title: MIDDLE (centered in orange bar)")
print("  - BRI description: TOP (content text)")
print("  - Initiative acronyms: MIDDLE (centered in colored boxes)")
print("  - Initiative names: TOP (multi-line text)")
print("  - Initiative descriptions: TOP (multi-line text)")
print()
print("All text now properly aligned and visible!")
print()
