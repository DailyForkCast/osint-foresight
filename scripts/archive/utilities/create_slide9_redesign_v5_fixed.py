...
# FIVE INITIATIVES - PROPERLY SIZED
initiatives_y = 1.67
...
for i, init in enumerate(initiatives):
    ...
    create_text_box(slide, x_pos, initiatives_y, initiative_width, 0.15,
                    ...
                    vertical_anchor=MSO_VERTICAL_ANCHOR.MIDDLE)  # MIDDLE for single line
    ...
    # Description - PROPER SIZE NOW
    # Calculate: 2 lines × 0.163" + padding 0.18" = 0.506" -> round to 0.50"
    desc_height = 0.50
    desc_box = create_colored_box(slide, x_pos, initiatives_y + 0.30, initiative_width, desc_height, COLORS['white'])
    create_text_box(slide, x_pos, initiatives_y + 0.30, initiative_width, desc_height,
                    init['desc'],
                    9, init['color'], alignment=PP_PARAGRAPH_ALIGNMENT.CENTER,
                    vertical_anchor=MSO_VERTICAL_ANCHOR.TOP)

# Bottom sections - adjusted position
# initiatives end at: 1.67 + 0.30 + 0.50 = 2.47
# Leave 0.30" gap: 2.47 + 0.30 = 2.77
bottom_y = 2.77
...
# Save
output_path = 'C:/Projects/OSINT-Foresight/MCF_Slide9_Redesign_v5_FINAL.pptx'
prs.save(output_path)

print("=" * 80)
print("SLIDE 9 V5 - PROPERLY SIZED BOXES")
print("=" * 80)
print()
print("FIXES from V4:")
print("  [X] Description boxes: 0.24\" -> 0.50\" (PROPER SIZE)")
print("  [X] Available text space: 0.32\" (after 0.18\" padding)")
print("  [X] Can fit 2 full lines of 9pt text comfortably")
print("  [X] Title centering maintained (V4 fix)")
print("  [X] All vertical alignments properly set")
print()
print("Box Height Calculations:")
print("  9pt font × 1.3 line spacing = 11.7pt = 0.163\" per line")
print("  2 lines = 0.326\"")
print("  + Padding (0.18\") = 0.506\"")
print("  -> Set to 0.50\" (rounded)")
print()
print("Spacing Flow:")
print("  Initiatives start: 1.67\"")
print("  Initiatives end: 1.67 + 0.30 + 0.50 = 2.47\"")
print("  Gap: 0.30\"")
print("  Bottom section: 2.77\"")
print("  Bottom boxes height: 1.5\" (ample room)")
print()
