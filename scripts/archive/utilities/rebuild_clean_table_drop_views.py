#!/usr/bin/env python3
"""
Rebuild Clean Table - Drop Views First
"""
...
def rebuild_clean_table():
    ...
    print("\n[1/6] Checking for dependent views...")
    cursor.execute("""
    ...
    if views:
        print(f"  Found {len(views)} dependent views")
    ...
    print("\n[3/6] Creating indexes on clean table...")
