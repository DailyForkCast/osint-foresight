...
# -*- coding: utf-8 -*-
"""
ETL: Expand bilateral_corporate_links from GLEIF - V4 FINAL (Schema Matched)
Purpose: Extract Chinese → European corporate ownership relationships

V4 Changes:
  - Matched actual bilateral_corporate_links schema
  - Simplified fields (no separate chinese_entity_lei, just gleif_lei)
  - Ready to load 170 relationships
...
class GLEIFCorporateLinksETL:
    ...
    def transform(self, relationships: List[Dict]) -> List[Dict]:
        ...
        for rel in relationships:
            ...
            # Match actual schema: link_id, investment_id, acquisition_id, country_code, gleif_lei,
            # chinese_entity, foreign_entity, relationship_type, ownership_percentage, created_at
            link = {
                'link_id': str(uuid.uuid4()),
                'investment_id': None,  # No investment record
                'acquisition_id': None,  # No acquisition record
                'country_code': rel['child_country'],
                'gleif_lei': rel['child_lei'],  # European entity LEI
                'chinese_entity': rel['parent_name'],  # Chinese parent
                'foreign_entity': rel['child_name'],  # European child
                'relationship_type': relationship_type,
                'ownership_percentage': None,  # GLEIF doesn't provide this
    ...
    def save_report(self, total_links: int):
        ...
        report = {
            ...
            "etl_script": "etl_corporate_links_from_gleif_v4_final.py",
    ...
    def run(self):
        ...
        print("\n" + "="*80)
        print("GLEIF CORPORATE LINKS ETL - V4 FINAL")
        print("="*80)
