"""
Search CORDIS for AI and machine learning projects
...
def search_ai_projects():
    ...
    # Comprehensive AI keywords covering major subfields
    ai_keywords = [
        'artificial intelligence', 'machine learning', 'deep learning', 'neural network',
        'natural language processing', 'NLP', 'computer vision', 'image recognition',
        'reinforcement learning', 'generative', 'transformer', 'large language model',
        'LLM', 'foundation model', 'multimodal', 'explainable AI', 'XAI',
        'federated learning', 'edge AI', 'AI chip', 'AI hardware', 'neuromorphic',
        'AI ethics', 'AI safety', 'AI governance', 'trustworthy AI',
        'robotics', 'autonomous', 'self-driving', 'computer-aided',
        'recommendation system', 'speech recognition', 'conversational AI',
        'knowledge graph', 'semantic', 'reasoning', 'planning',
        'AI security', 'adversarial', 'AI bias', 'fairness'
    ]
    ...
    if h2020_path.exists():
        with open(h2020_path, 'r', encoding='utf-8') as f:
            try:
                ...
                print(f"Found {len(results['h2020_projects'])} H2020 AI projects")
    ...
    if horizon_path.exists():
        with open(horizon_path, 'r', encoding='utf-8') as f:
            try:
                ...
                print(f"Found {len(results['horizon_projects'])} Horizon Europe AI projects")
            except Exception as e:
                print(f"Error: {e}")
    ...
    report = {
        ...
        'query_date': '2025-10-07',
        'search_keywords': ai_keywords,
        'total_ai_projects': len(all_projects),
        'breakdown': {
    ...
    # Save
    output_path = "C:/Projects/OSINT - Foresight/analysis/ai_tech/cordis_ai_projects.json"
    ...
    print(f"\n=== CORDIS AI ANALYSIS ===")
    print(f"Total AI projects: {report['total_ai_projects']}")
